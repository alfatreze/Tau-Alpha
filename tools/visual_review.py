...
STATES = [
    ...
    {"id": "settings-stress", "status": "model", "file": "settings-stress.framebuffer.png",
     "note": "Diagnostic Build Stress page: level, soak, status."},
    {"id": "settings-stress-level", "status": "model", "file": "settings-stress-level.framebuffer.png",
     "note": "Stress level choice list (off, R1-R3), active option marked."},
    {"id": "settings-soak", "status": "model", "file": "settings-soak.framebuffer.png",
     "note": "Timed soak choice list (off, 5-60 min)."},

...
module tb_tau_sdram_cpu_return_probe;
    ...
    tau_sdram_cpu_window_probe #(.RETURN_PATH_MODE(1)) dut (
        ...
        .wb_ack(1'b0), .unsupported(1'b0), .adapter_write(1'b0),
        ...
        .bridge_wdata_all_ones(1'b0), .bridge_be_all_enabled(1'b0),
        .bridge_lo_write_accepted(1'b0), .bridge_hi_write_accepted(1'b0),
        .ctrl_write_latched(1'b0), .ctrl_write_data_all_ones(1'b0),
        .ctrl_write_be_all_enabled(1'b0), .ctrl_write_command(1'b0),
        .ctrl_write_dq_enabled(1'b0), .ctrl_write_dq_all_ones(1'b0),
        .ctrl_write_dqm_unmasked(1'b0), .ctrl_follow_read_seen(1'b0),
